  ...
  am: [
    {
      ...
      verse: '"የእግዚአብሔር መንፈስ በኃይል ወረደበት።" - መሳፍንት 14:6',
    ...
    },
    {
      ...
      title: 'ኢየሱስ',
      bibleRef: 'ማቴዎስ 1-28',
      verse: '"እግዚአብሔር አንድያ ልጁን እስከ መስጠት ድረስ ዓለምን እንዲሁ ወድዷልና።" - ዮሐንስ 3:16',
    ...
    },
    {
      ...
      title: 'ቃሉ',
      bibleRef: 'ዘጸአት 20',
      verse: '"ከእኔ በፊት ሌሎች አምላክት አይኑሩህ።" - ዘጸአት 20:3',
    ...
    },
    {
      ...
      title: 'ፍጥረት',
      bibleRef: 'ዘፍጥረት 1',
      verse: '"በመጀመሪያ ላይ እግዚአብሔር ሰማያትንና ምድርን ፈጠረ።" - ዘፍጥረት 1:1',
    ...
    },
    {
      ...
      title: 'ሁሉም ዓለም',
      bibleRef: 'ዘፍጥረት 2-3',
      verse: '"እግዚአብሔር አምላክ ከቈዳ ልብስ አዘጋጅቶ አዳምንና ሚስቱን አለበሳቸው።" - ዘፍጥረት 3:21',
...
const VERSES_CONTENT = {
  ...
  am: [
    ...
    '"እግዚአብሔር አንድያ ልጁን እስከ መስጠት ድረስ ዓለምን እንዲሁ ወድዷልና።" - ዮሐንስ 3:16',
    '"በፍጹም ልብህ በእግዚአብሔር ታመን፤ በራስህ ማስተዋል አትደገፍ።" - ምሳሌ 3:5',
    '"ኀይልን በሚሰጠኝ በርሱ ሁሉን ማድረግ እችላለሁ።" - ፊልጵስዩስ 4:13',
    '"አይዞህ፤ በርታ፤ ጽና፤ አትፍራ፤ አትደንግጥ ብዬ አላዘዝሁህምን?" - ኢያሱ 1:9',
    '"በፊታችን ያለውን ሩጫ በጽናት እንሩጥ።" - ዕብራውያን 12:1',
...
const BIBLICAL_QUESTIONS_CONTENT = {
  ...
  am: [
    ...
    {
      question: "ከበለአም ጋር የተነጋገረው እንስሳ ምንድን ነው?",
